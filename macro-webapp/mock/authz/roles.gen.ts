...
export const mockRoles: readonly { readonly name: string; readonly grants: readonly string[] }[] = [
  { name: "Client", grants: ["coach-access:manage", "daily-goal:read", "daily-goal:write", "food-entries:read", "food-entries:write", "progress:read"] },
  { name: "Coach", grants: ["coach-access:read", "daily-goal:read-granted", "food-entries:read-granted", "progress:read-granted"] },
];
